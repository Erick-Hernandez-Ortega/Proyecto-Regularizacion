            ...
            <div class="modal-dialog">
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <h5 style="font-weight:bold;"> Ingresa las credenciales de un administrador y elige el rol del nuevo usuario para confirmar el registro.</h5>
                  <label style="padding-top: 8px;" for="">Rol del nuevo usuario</label>
