...
<body>
        ...
        <table class="table table-hover text-center " id="tablaCentral">
            ...
            <tbody>
                <tr class="table-light">
                    ...
                    <td><button type="button" class="btn btn-success px-1" data-bs-toggle="modal"
                    ...
                    <td><button type="button" class="btn btn-warning px-1" data-bs-toggle="modal"
        ...
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <a href="src/docs/Solicitud de regularizacion.pdf" target="_blank"
                        download="Solicitud de regularización.pdf"
                        class="text-decoration-none btn btn-secondary mt-1 mx-3 mb-1">Generar solicitud de
                        regularización</a>
    ...
    <div class="modal fade" id="modalProceso2" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
        aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                <div class="modal-header">
    ...
    <!-- Modal proceso 3 -->
    <div class="modal fade" id="modalProceso3" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
        aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                <div class="modal-header">
    ...
    <!-- Modal proceso 4 -->
    <div class="modal fade" id="modalProceso4" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
        aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                <div class="modal-header">
    ...
    <!-- Modal proceso 5 -->
    <div class="modal fade" id="modalProceso5" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
        aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                <div class="modal-header">
    ...
    <!-- Modal proceso 6 -->
    <div class="modal fade" id="modalProceso6" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
        aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                <div class="modal-header">
    ...
    <!-- Modal proceso 7  -->
    <div class="modal fade" id="modalProceso7" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
        aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="row gy-4 gx-5">
                    ...
                    <div class="col-lg-2 col-md-6">
                        ...
                        <ul class="list-unstyled text-muted">
                            <li>
                                <a href="#">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="50" height="30" fill="black"
