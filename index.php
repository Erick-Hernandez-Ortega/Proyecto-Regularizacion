...
if (!isset($_SESSION['reloadindex'])) {
    header('Refresh: 0');
    $_SESSION['reloadindex'] = 1;
}
?>
<!DOCTYPE html>
<html lang="es">
...
<body>
    ...
    <div class="agregar-folio mt-3">
        <button class="btn btn-dark mb-2 d-flex rounded-4 btn-lg" style="box-shadow: rgba(0, 0, 0, 0.56) 0px 22px 70px 4px;" data-bs-toggle="tooltip" data-bs-placement="right" data-bs-title="Agregar Folio">
