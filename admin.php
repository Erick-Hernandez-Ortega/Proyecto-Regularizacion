...
if (!isset($_SESSION['reloadadmin'])) {
    header('Refresh: 0');
    $_SESSION['reloadadmin'] = 1;
} ?>
<!DOCTYPE html>
<html lang="es">
...
<body>
    ...
    <div class="text-center bs">
        <div class="row w-100">
            <a class="col text-decoration-none link p-2 borde text-light" href="admin.php">
                Principal
            </a>
    ...
    <div class="agregar-folio mt-3">
        <div class="btn-group">
            <button class="btn btn-dark d-flex rounded-4" style="box-shadow: rgba(0, 0, 0, 0.2) 0px 12px 28px 0px, rgba(0, 0, 0, 0.1) 0px 2px 4px 0px, rgba(255, 255, 255, 0.05) 0px 0px 0px 1px inset;" data-bs-toggle="tooltip" data-bs-placement="bottom" data-bs-title="Agregar Folio">
                <span class="material-icons" style="font-size: 27px;" data-bs-toggle="modal" data-bs-target="#modalFolio">&#xe2cc;</span>
            </button>
        </div>
        <a href="archivado.php" class="btn btn-dark" style="box-shadow: rgba(0, 0, 0, 0.2) 0px 12px 28px 0px, rgba(0, 0, 0, 0.1) 0px 2px 4px 0px, rgba(255, 255, 255, 0.05) 0px 0px 0px 1px inset;" data-bs-toggle="tooltip" data-bs-placement="bottom" data-bs-title="Mostrar archivados">
    ...
    <!-- Modal proceso 1-->
    <?php
    $sql2 = "SELECT * FROM solicitud_de_regularizacion WHERE archivar = false";
                        ...
                        <div class="modal-body">
                            ...
                            <div class="row mb-3">
                                <div class="col">
                                    ...
                                    <span class="material-icons position-absolute <?php if ($mod['solicidud_estatus'] == true) {
                                                                                        echo 'verde';
                                                                                        $icon = '&#xe2e6;';
                                                                                        $a = 1;
                                                                                    } else {
                                ...
                                <div class="col">
                                    ...
                                    <span class="material-icons position-absolute <?php if ($mod['escritura_estatus'] == true) {
                                                                                        echo 'verde';
                                                                                        $icon = '&#xe2e6;';
                                                                                        $b = 1;
                                                                                    } else {
                            ...
                            <div class="row mb-3">
                                <div class="col">
                                    ...
                                    <span class="material-icons position-absolute <?php if ($mod['identificacion_estatus'] == true) {
                                                                                        echo 'verde';
                                                                                        $icon = '&#xe2e6;';
                                                                                        $c = 1;
                                                                                    } else {
                                ...
                                <div class="col">
                                    ...
                                    <span class="material-icons position-absolute <?php if ($mod['historial_catastral_estatus'] == true) {
                                                                                        echo 'verde';
                                                                                        $icon = '&#xe2e6;';
                                                                                        $d = 1;
                                                                                    } else {
                            ...
                            <div class="row mb-3">
                                <div class="col">
                                    ...
                                    <span class="material-icons position-absolute <?php if ($mod['resolucion_idicial_estatus'] == true) {
                                                                                        echo 'verde';
                                                                                        $icon = '&#xe2e6;';
                                                                                        $e = 1;
                                                                                    } else {
                                ...
                                <div class="col">
                                    ...
                                    <span class="material-icons position-absolute <?php if ($mod['certificacion_de_hechos_estatus'] == true) {
                                                                                        echo 'verde';
                                                                                        $icon = '&#xe2e6;';
                                                                                        $f = 1;
                                                                                    } else {
                            ...
                            <div class="row mb-3">
                                <div class="col">
                                    ...
                                    <span class="material-icons position-absolute <?php if ($mod['foto_aerea_estatus'] == true) {
                                                                                        echo 'verde';
                                                                                        $icon = '&#xe2e6;';
                                                                                        $g = 1;
                                                                                    } else {
                                ...
                                <div class="col">
                                    ...
                                    <span class="material-icons position-absolute <?php if ($mod['oficio_estatus'] == true) {
                                                                                        echo 'verde';
                                                                                        $icon = '&#xe2e6;';
                                                                                        $h = 1;
                                                                                    } else {
                            ...
                            <div class="row mb-3">
                                <div class="col">
                                    ...
                                    <span class="material-icons position-absolute <?php if ($mod['oficio_regreso'] != null) {
                                                                                        echo 'verde';
                                                                                        $icon = '&#xe2e6;';
                                                                                        $i = 1;
                                                                                    } else {
                    ...
                    <form action="src/php/proceso2.php" method="POST" enctype="multipart/form-data">
                        <div class="modal-body">
                            ...
                            <div class="row mb-3">
                                <div class="col">
                                    <label for="formFile" class="form-label fw-bold">Oficio</label>
                                    <span class="material-icons position-absolute <?php if ($p2['oficio_estatus'] == true) {
                                                                                        echo 'verde';
                                                                                        $icon = '&#xe2e6;';
                                                                                        $a = 1;
                                                                                    } else {
                                ...
                                <div class="col">
                                    ...
                                    <span class="material-icons position-absolute <?php if ($p2['solicitud_de_regularizacion_estatus'] == true) {
                                                                                        echo 'verde';
                                                                                        $icon = '&#xe2e6;';
                                                                                        $b = 1;
                                                                                    } else {
                            ...
                            <div class="row mb-3">
                                <div class="col">
                                    ...
                                    <span class="material-icons position-absolute <?php if ($p2['estudio_de_analisis_estatus'] == true) {
                                                                                        echo 'verde';
                                                                                        $icon = '&#xe2e6;';
                                                                                        $c = 1;
                                                                                    } else {
                                ...
                                <div class="col">
                                    ...
                                    <span class="material-icons position-absolute <?php if ($mod['acta_comur_estatus'] == true) {
                                                                                        echo 'verde';
                                                                                        $icon = '&#xe2e6;';
                                                                                        $d = 1;
                                                                                    } else {
                            ...
                            <div class="row mb-3">
                                <div class="col">
                                    ...
                                    <span class="material-icons position-absolute <?php if ($p2['oficio_regreso'] != null) {
                                                                                        echo 'verde';
                                                                                        $icon = '&#xe2e6;';
                                                                                        $e = 1;
                                                                                    } else {
                    ...
                    <form action="src/php/proceso3.php" method="POST" enctype="multipart/form-data">
                        <div class="modal-body">
                            ...
                            <div class="row mb-3">
                                <div class="col">
                                    <label for="formFile" class="form-label fw-bold">Oficio</label>
                                    <span class="material-icons position-absolute <?php if ($p3['oficio_estatus'] == true) {
                                                                                        echo 'verde';
                                                                                        $icon = '&#xe2e6;';
                                                                                        $a = 1;
                                                                                    } else {
                                ...
                                <div class="col">
                                    ...
                                    <span class="material-icons position-absolute <?php if ($p3['estudio_opinion_estatus'] == true) {
                                                                                        echo 'verde';
                                                                                        $icon = '&#xe2e6;';
                                                                                        $b = 1;
                                                                                    } else {
                            ...
                            <div class="row mb-3">
                                <div class="col">
                                    ...
                                    <span class="material-icons position-absolute <?php if ($p3['acta_de_comur_proceso_2_estatus'] == true) {
                                                                                        echo 'verde';
                                                                                        $icon = '&#xe2e6;';
                                                                                        $c = 1;
                                                                                    } else {
                                ...
                                <div class="col">
                                    ...
                                    <span class="material-icons position-absolute <?php if ($p3['acta_comur_2_estatus'] == true) {
                                                                                        echo 'verde';
                                                                                        $icon = '&#xe2e6;';
                                                                                        $d = 1;
                                                                                    } else {
                            ...
                            <div class="row mb-3">
                                <div class="col">
                                    <label for="formFile" class="form-label fw-bold">Oficio Regreso</label>
                                    <span class="material-icons position-absolute <?php if ($p3['oficio_regreso'] != null) {
                                                                                        echo 'verde';
                                                                                        $icon = '&#xe2e6;';
                                                                                        $e = 1;
                                                                                    } else {
                        ...
                        <div class="modal-body">
                            ...
                            <div class="row mb-3">
                                <div class="col">
                                    ...
                                    <span class="material-icons position-absolute <?php if ($p4['dictamen_estatus'] == true) {
                                                                                        echo 'verde';
                                                                                        $icon = '&#xe2e6;';
                                                                                        $a = 1;
                                                                                    } else {
                                ...
                                <div class="col">
                                    <label for="formFile" class="form-label fw-bold">Oficio</label>
                                    <span class="material-icons position-absolute <?php if ($p4['oficio_estatus'] == true) {
                                                                                        echo 'verde';
                                                                                        $icon = '&#xe2e6;';
                                                                                        $b = 1;
                                                                                    } else {
                            ...
                            <div class="row mb-3">
                                <div class="col">
                                    <label for="formFile" class="form-label fw-bold">Oficio Regreso</label>
                                    <span class="material-icons position-absolute <?php if ($p4['oficio_regreso'] != null) {
                                                                                        echo 'verde';
                                                                                        $icon = '&#xe2e6;';
                                                                                        $c = 1;
                                                                                    } else {
                    ...
                    <form action="src/php/proceso5.php" method="POST" enctype="multipart/form-data">
                        <div class="modal-body">
                            ...
                            <div class="row mb-3">
                                <div class="col">
                                    <label for="formFile" class="form-label fw-bold">Oficio</label>
                                    <span class="material-icons position-absolute <?php if ($p5['oficio_estatus'] == true) {
                                                                                        echo 'verde';
                                                                                        $icon = '&#xe2e6;';
                                                                                        $a = 1;
                                                                                    } else {
                                ...
                                <div class="col">
                                    ...
                                    <span class="material-icons position-absolute <?php if ($p5['dictamen_prodeur_estatus'] == true) {
                                                                                        echo 'verde';
                                                                                        $icon = '&#xe2e6;';
                                                                                        $b = 1;
                                                                                    } else {
                            ...
                            <div class="row mb-3">
                                <div class="col">
                                    ...
                                    <span class="material-icons position-absolute <?php if ($p5['acta_de_comur_1_estatus'] == true) {
                                                                                        echo 'verde';
                                                                                        $icon = '&#xe2e6;';
                                                                                        $c = 1;
                                                                                    } else {
                                ...
                                <div class="col">
                                    <label for="formFile" class="form-label fw-bold">Acta de COMUR 2</label>
                                    <span class="material-icons position-absolute <?php if ($p5['acta_de_comur_2_estatus'] == true) {
                                                                                        echo 'verde';
                                                                                        $icon = '&#xe2e6;';
                                                                                        $d = 1;
                                                                                    } else {
                            ...
                            <div class="row mb-3">
                                <div class="col">
                                    ...
                                    <span class="material-icons position-absolute <?php if ($p5['publicacion_estatus'] == true) {
                                                                                        echo 'verde';
                                                                                        $icon = '&#xe2e6;';
                                                                                        $e = 1;
                                                                                    } else {
                                ...
                                <div class="col">
                                    <label for="formFile" class="form-label fw-bold">Estudio análisis y resolución del
                                        expediente</label>
                                    <span class="material-icons position-absolute <?php if ($p5['estudio_analisis_y_resolucion_del_expediente_estatus'] == true) {
                                                                                        echo 'verde';
                                                                                        $icon = '&#xe2e6;';
                                                                                        $f = 1;
                                                                                    } else {
                            ...
                            <div class="row mb-3">
                                <div class="col">
                                    <label for="formFile" class="form-label fw-bold">Estudio de opinión</label>
                                    <span class="material-icons position-absolute <?php if ($p5['estudio_de_opinion_estatus'] == true) {
                                                                                        echo 'verde';
                                                                                        $icon = '&#xe2e6;';
                                                                                        $g = 1;
                                                                                    } else {
                                ...
                                <div class="col">
                                    <label for="formFile" class="form-label fw-bold">Oficio regreso</label>
                                    <span class="material-icons position-absolute <?php if ($p5['oficion_regreso'] != null) {
                                                                                        echo 'verde';
                                                                                        $icon = '&#xe2e6;';
                                                                                        $h = 1;
                                                                                    } else {
                        ...
                        <div class="modal-body">
                            ...
                            <div class="row mb-3">
                                <div class="col">
                                    ...
                                    <span class="material-icons position-absolute <?php if ($p6['proyecto_definitivo_estatus'] == true) {
                                                                                        echo 'verde';
                                                                                        $icon = '&#xe2e6;';
                                                                                        $a = 1;
                                                                                    } else {
                        ...
                        <div class="modal-body">
                            ...
                            <div class="row mb-3">
                                <div class="col">
                                    ...
                                    <span class="material-icons position-absolute <?php if ($p7['oficio_de_castastro_estatus'] == true) {
                                                                                        echo 'verde';
                                                                                        $icon = '&#xe2e6;';
                                                                                        $a = 1;
                                                                                    } else {
                                ...
                                <div class="col">
                                    <label for="formFile" class="form-label fw-bold">Convenio de regularización (Solo
                                        archivo)</label>
                                    <span class="material-icons position-absolute <?php if ($p7['convenio_de_regularizacion'] == null) {
                                                                                        echo 'rojo';
                                                                                        $icon = '&#xe5c9;';
                                                                                        $b = 0;
                                                                                    } else {
                            ...
                            <div class="row mb-3">
                                <div class="col">
                                    ...
                                    <span class="material-icons position-absolute <?php if ($p7['firma_presidente'] != null) {
                                                                                        echo 'verde';
                                                                                        $icon = '&#xe2e6;';
                                                                                        $c = 1;
                                                                                    } else {
                            ...
                            <div class="row mb-3">
                                <div class="col">
                                    ...
                                    <span class="material-icons position-absolute <?php if ($p7['firma_sindico'] != null) {
                                                                                        echo 'verde';
                                                                                        $icon = '&#xe2e6;';
                                                                                        $e = 1;
                                                                                    } else {
                            ...
                            <div class="row mb-3">
                                <div class="col">
                                    ...
                                    <span class="material-icons position-absolute <?php if ($p7['firma_secretaria_general'] != null) {
                                                                                        echo 'verde';
                                                                                        $icon = '&#xe2e6;';
                                                                                        $g = 1;
                                                                                    } else {
                            ...
                            <div class="row mb-3">
                                <div class="col">
                                    ...
                                    <span class="material-icons position-absolute <?php if ($p7['firma_tesorero'] != null) {
                                                                                        echo 'verde';
                                                                                        $icon = '&#xe2e6;';
                                                                                        $i = 1;
                                                                                    } else {
                            ...
                            <div class="row mb-3">
                                <div class="col">
                                    ...
                                    <span class="material-icons position-absolute <?php if ($p7['firma_presidente_de_comite_o_propietario'] != null) {
                                                                                        echo 'verde';
                                                                                        $icon = '&#xe2e6;';
                                                                                        $k = 1;
                                                                                    } else {
                            ...
                            <div class="row mb-3">
                                <div class="col">
                                    ...
                                    <span class="material-icons position-absolute <?php if ($p7['firma_secretario_tecnico'] != null) {
                                                                                        echo 'verde';
                                                                                        $icon = '&#xe2e6;';
                                                                                        $m = 1;
                                                                                    } else {
                            ...
                            <div class="row mb-3">
                                <div class="col">
                                    ...
                                    <span class="material-icons position-absolute <?php if ($p7['firma_procurador_de_desarrollo_urbano'] != null) {
                                                                                        echo 'verde';
                                                                                        $icon = '&#xe2e6;';
                                                                                        $o = 1;
                                                                                    } else {
    ...
    <!-- Modal Eliminar-->
    <?php $fol = "SELECT * FROM solicitud_de_regularizacion WHERE archivar = false";
        ...
        <div class="modal fade" id="<?= $f['folio'] ?>" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
            <div class="modal-dialog modal-x1">
                <div class="modal-content">
                    ...
                    <form action="src/php/archivar.php" method="post">
                        <div class="modal-body">
                    ...
                    <input type="text" readonly class="form-control-plaintext" name="folio" id="folio" value="<?= $f['folio'] ?>"> -->
                        ...
                        <div class="modal-footer">
                            <button type="submit" class="btn btn-danger" data-dismiss="modal">Archivar</button>
