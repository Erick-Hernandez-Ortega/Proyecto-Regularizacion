...
if (!isset($_SESSION['reloadbusqueda'])) {
    header('Refresh: 0');
    $_SESSION['reloadbusqueda'] = 1;
}
?>
<!DOCTYPE html>
<html lang="es">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row mb-3">
                            <div class="col">
                                ...
                                <span class="material-icons position-absolute <?php if ($p7['firma_presidente_estatus'] == true) {
                                                                                    echo 'verde';
                                                                                    $icon = '&#xe2e6;';
                                                                                    $c = 1;
                                                                                } else {
                        ...
                        <div class="row mb-3">
                            <div class="col">
                                ...
                                <span class="material-icons position-absolute <?php if ($p7['firma_sindico_estatus'] == true) {
                                                                                    echo 'verde';
                                                                                    $icon = '&#xe2e6;';
                                                                                    $e = 1;
                                                                                } else {
                        ...
                        <div class="row mb-3">
                            <div class="col">
                                ...
                                <span class="material-icons position-absolute <?php if ($p7['firma_secretaria_general_estatus'] == true) {
                                                                                    echo 'verde';
                                                                                    $icon = '&#xe2e6;';
                                                                                    $g = 1;
                                                                                } else {
                        ...
                        <div class="row mb-3">
                            <div class="col">
                                ...
                                <span class="material-icons position-absolute <?php if ($p7['firma_tesorero_estatus'] == true) {
                                                                                    echo 'verde';
                                                                                    $icon = '&#xe2e6;';
                                                                                    $i = 1;
                                                                                } else {
                        ...
                        <div class="row mb-3">
                            <div class="col">
                                ...
                                <span class="material-icons position-absolute <?php if ($p7['firma_presidente_de_comite_o_propietario_estatus'] == true) {
                                                                                    echo 'verde';
                                                                                    $icon = '&#xe2e6;';
                                                                                    $k = 1;
                                                                                } else {
                        ...
                        <div class="row mb-3">
                            <div class="col">
                                ...
                                <span class="material-icons position-absolute <?php if ($p7['firma_secretario_tecnico_estatus'] == true) {
                                                                                    echo 'verde';
                                                                                    $icon = '&#xe2e6;';
                                                                                    $m = 1;
                                                                                } else {
                        ...
                        <div class="row mb-3">
                            <div class="col">
                                ...
                                <span class="material-icons position-absolute <?php if ($p7['firma_procurador_de_desarrollo_urbano_estatus'] == true) {
                                                                                    echo 'verde';
                                                                                    $icon = '&#xe2e6;';
                                                                                    $o = 1;
                                                                                } else {
